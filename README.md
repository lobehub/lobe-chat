...
- **[BurnCloud](https://lobechat.com/dicover/provider/burncloud)**:
  BurnCloud provides stable, cost-effective open-source model API services, supporting industry-leading large language models including Claude 4.0/3.7/3.5, GPT 4o/4o-mini/o1/4.5 preview/o1-mini, GPT-image-1, Gemini 2.5 pro/2.0, DeepSeek R1/V3, and more.
