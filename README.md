...
| [Pitch Deck Maestro (Elevator Pitch)](https://chat-preview.lobehub.com/market?agent=pitch-deck)<br/><sup>By **[SimoMay](https://github.com/SimoMay)** on **2024-03-05**</sup>                     | Specialises in creating high-quality Pitch Decks for startups to attract investors effectively.<br/>`startup-advisor` `pitch-deck` `entrepreneur` `investor`                                               |

> 📊 Total agents: [<kbd>**198**</kbd> ](https://github.com/lobehub/lobe-chat-agents)
