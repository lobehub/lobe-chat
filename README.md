...
| [Case Solver](https://chat-preview.lobehub.com/market?agent=detective-game-assistant)<br/><sup>By **[Sheldon23357](https://github.com/Sheldon23357)** on **2023-12-15**</sup> | A game to solve a murder case provided by the user<br/>`detective` `game` `reasoning` `puzzle` `investigation`                                                  |
| [Case Generator](https://chat-preview.lobehub.com/market?agent=detective-novelist)<br/><sup>By **[Sheldon23357](https://github.com/Sheldon23357)** on **2023-12-15**</sup>    | Specializes in creating murder mystery stories in the style of red herring. <br/>`detective` `game` `reasoning` `puzzle` `investigation`                        |

> 📊 Total agents: [<kbd>**70**</kbd> ](https://github.com/lobehub/lobe-chat-agents)
