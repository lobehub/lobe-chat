...
describe('LobeMinimaxAI', () => {
  ...
  describe('chat', () => {
    ...
    describe('Error', () => {
      ...
      it('should throw an InvalidMinimaxAPIKey error type on 401 status code', async () => {
        ...
        try {
          ...
          // Expect the chat method to throw an error with InvalidMinimaxAPIKey
          expect(e).toEqual({
            endpoint: defaultBaseURL,
    ...
    describe('LobeMinimaxAI chat with callback and headers', () => {
    ...
    describe('DEBUG', () => {
      it('should call debugStream and return StreamingTextResponse when DEBUG_MINIMAX_CHAT_COMPLETION is 1', async () => {
        // Arrange
        ...
        // 保存原始环境变量值
        const originalDebugValue = process.env.DEBUG_MINIMAX_CHAT_COMPLETION;
        ...
        // 恢复原始环境变量值
        process.env.DEBUG_MINIMAX_CHAT_COMPLETION = originalDebugValue;
      });
    });
  });
});
