export default {
  dbV1: {
    ...
    description:
      '在新版本中，ChatHwBaby 的数据存储有了巨大的飞跃。因此我们要对旧版数据进行升级，进而为你带来更好的使用体验。',
    features: {
      capability: {
    ...
    upgrade: {
      ...
      success: {
        subTitle: 'ChatHwBaby 的数据库已经升级到最新版本，立即开始体验吧',
        title: '数据库升级成功',
      },
    },
    upgradeTip: '升级大致需要 10~20 秒，升级过程中请不要关闭 ChatHwBaby',
  },
  migrateError: {
