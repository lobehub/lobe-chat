export default {
  ...
  'llm.customModelCards.modelConfig.id.placeholder':
    '请输入模型id，例如 gpt-4-turbo-preview 或 claude-2.1',
  ...
  'memory.enabled.desc':
    '开启后，助理会在你允许的范围内从对话中提取偏好与信息，形成记忆并在后续对话中参考。你可以随时查看、编辑或清除记忆',
  ...
  'settingAppearance.contextMenuMode.desc': '选择聊天消息右键菜单的显示方案',
  ...
  'settingChat.historyCount.desc':
    '每次请求携带的消息数（包括最新编写的提问。每个提问和回答都计算1）',
  ...
  'settingChatAppearance.fontSize.desc': '聊天内容的字体大小',
  ...
  'settingChatAppearance.transitionMode.desc': '聊天消息的过渡动画',
  ...
  'settingCommon.liteMode.desc': '开启后将简化界面，隐藏高级功能',
  ...
  'settingGroupChat.systemPrompt.desc':
    '群聊对话主持人的自定义系统提示词。这可能影响默认的主持人行为。',
  ...
  'settingOpening.openingMessage.placeholder':
    '你好，我是自定义助理。你可以立即与我开始对话，也可以前往助理设置完善我的信息。',
  ...
  'submitFooter.reset': '重置',
  'submitFooter.submit': '保存',
  'submitFooter.unSaved': '未保存更改',
  'submitFooter.unSavedWarning': '当前有未保存的更改',
  ...
  'sync.warning.tip':
    '经过较长一段时间社区公测，WebRTC 同步可能无法稳定满足通用的数据同步诉求。请自行 <1>部署信令服务器</1> 后使用。',
  ...
  'systemAgent.generationTopic.modelDesc': '指定用于 AI 绘画自动命名话题的模型',
  'systemAgent.generationTopic.title': 'AI 绘画话题命名助理',
