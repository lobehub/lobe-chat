export default {
    ...
    list: {
      actions: {
        ...
        deleteConfirm: {
          ...
          content: '删除后将无法再用此 API Key 访问接口。需要时你可以随时创建新的 API Key。',
  ...
  betterAuth: {
    errors: {
      ...
      loginFailed: '登录遇到了问题。请检查账号与密码后重试',
    ...
    signin: {
      ...
      error: '登录遇到了问题。请检查账号与密码后重试',
      forgotPassword: '忘记密码？',
      forgotPasswordError: '发送遇到了问题。你可以稍后再试',
      forgotPasswordSent: '已发送重置链接，请检查邮箱',
      magicLinkButton: '发送登录链接',
      magicLinkError: '发送遇到了问题。你可以稍后再试',
      magicLinkSent: '登录链接已发送，请查收邮箱',
      nextStep: '下一步',
      noAccount: '还没有账号？',
  ...
  profile: {
    ...
    resetPasswordSent: '已发送重置链接，请查收邮箱',
    save: '保存',
    setPassword: '设置密码',
    sso: {
      link: {
