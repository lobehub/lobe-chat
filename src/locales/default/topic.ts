export default {
  ...
  'actions.confirmRemoveAll': '将删除全部话题，删除后不可恢复。建议先导出重要内容，再确认继续',
  'actions.confirmRemoveTopic':
    '将删除该话题，删除后不可恢复。建议先复制需要保留的内容，再确认继续',
  'actions.confirmRemoveUnstarred': '将删除未收藏的话题，删除后不可恢复。建议确认无误再继续',
