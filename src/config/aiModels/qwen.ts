...
const qwenChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 2.4, strategy: 'fixed', unit: 'MillionTokens' }, // tokens 32K ~ 128K
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 0.6, strategy: 'fixed', unit: 'MillionTokens' }, // tokens 32K ~ 128K
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 0.12, strategy: 'fixed', unit: 'MillionTokens' },
        { name: 'TextInput', rate: 0.3, strategy: 'fixed', unit: 'MillionTokens' },
        { name: 'TextOutput', rate: 3, strategy: 'fixed', unit: 'MillionTokens' },
      ],
    },
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 0.32, strategy: 'fixed', unit: 'MillionTokens' },
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 0.96, strategy: 'fixed', unit: 'MillionTokens' },
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 0.6, strategy: 'fixed', unit: 'MillionTokens' },
        { name: 'TextInput', rate: 1.5, strategy: 'fixed', unit: 'MillionTokens' },
        { name: 'TextOutput', rate: 4.5, strategy: 'fixed', unit: 'MillionTokens' },
      ],
    },
  ...
  },
  {
    ...
    pricing: {
      currency: 'CNY',
      units: [
        { name: 'CachedTextInput', rate: 1.2, strategy: 'fixed', unit: 'MillionTokens' },
