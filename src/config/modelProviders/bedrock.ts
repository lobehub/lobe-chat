...
const Bedrock: ModelProviderCard = {
  chatModels: [
    ...
    {
      description: 'Llama 3 8B Instruct，上下文大小为 8k',
    ...
    {
      description: 'Llama 3 70B Instruct，上下文大小为 8k',
    ...
    {
      description: 'Mistral 7B Instruct，上下文大小为 32k',
    ...
    {
      description: 'Mixtral 8x7B Instruct，上下文大小为 32k',
    ...
    {
      description: 'Mistral Large，上下文大小为 32k',
    ...
    {
      description: 'Stability AI，上下文大小为 77',
