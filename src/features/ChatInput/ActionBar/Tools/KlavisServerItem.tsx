...
const KlavisServerItem = memo<KlavisServerItemProps>(({ label, server, type }) => {
  ...
  // Get plugin ID for this server (直接使用 serverName 作为 identifier)
  const pluginId = server ? server.serverName : '';
