...
import PluginInstallConfirmModal from './PluginInstallConfirmModal';
import { McpInstallRequest } from './PluginInstallConfirmModal/types';
...
const ProtocolUrlHandler = () => {
  ...
  const handleMcpInstallRequest = useCallback(
    (data: { marketId?: string; pluginId: string; schema: any; source: string }) => {
      // 将原始数据传递给子组件处理
