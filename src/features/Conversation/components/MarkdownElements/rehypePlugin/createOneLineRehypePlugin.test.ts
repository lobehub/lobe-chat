...
import createOneLineRehypePlugin from './createOneLineRehypePlugin';

describe('createRehypePlugin', () => {
  it('should transform <lobeThinking> tags within paragraphs', () => {
    ...
    const plugin = createOneLineRehypePlugin(ARTIFACT_THINKING_TAG)();
    plugin(tree);
