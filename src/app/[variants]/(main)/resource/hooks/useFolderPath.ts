 ...
 *
 * Example URLs:
 * - /knowledge/library/kb_123 -> { knowledgeBaseId: 'kb_123', currentFolderSlug: null, isInKnowledgeBase: true }
 * - /knowledge/library/kb_123/folder-slug-1 -> { knowledgeBaseId: 'kb_123', currentFolderSlug: 'folder-slug-1', isInKnowledgeBase: true }
...
export const useFolderPath = () => {
  ...
  const isInKnowledgeBase = location.pathname.includes('/knowledge/library/');
