 ...
 *
 * Example URLs:
 * - /knowledge/repo/kb_123 -> { knowledgeBaseId: 'kb_123', currentFolderSlug: null, isInKnowledgeBase: true }
 * - /knowledge/repo/kb_123/folder-slug-1 -> { knowledgeBaseId: 'kb_123', currentFolderSlug: 'folder-slug-1', isInKnowledgeBase: true }
