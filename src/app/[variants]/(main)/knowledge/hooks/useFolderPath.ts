 ...
 *
 * Example URLs:
 * - /knowledge/repo/kb_123 -> { knowledgeBaseId: 'kb_123', folderPath: null, folderSegments: [], currentFolderSlug: null, isInKnowledgeBase: true }
 * - /knowledge/repo/kb_123/folder-1 -> { knowledgeBaseId: 'kb_123', folderPath: 'folder-1', folderSegments: ['folder-1'], currentFolderSlug: 'folder-1', isInKnowledgeBase: true }
 * - /knowledge/repo/kb_123/folder-1/folder-2 -> { knowledgeBaseId: 'kb_123', folderPath: 'folder-1/folder-2', folderSegments: ['folder-1', 'folder-2'], currentFolderSlug: 'folder-2', isInKnowledgeBase: true }
...
export const useFolderPath = () => {
  ...
  const isInKnowledgeBase = location.pathname.includes('/knowledge/repo/');
