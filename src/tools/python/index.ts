...
export const PythonManifest: BuiltinToolManifest = {
  ...
  systemRole: `When you send a message containing Python code to python, it will be executed in a pyodide python environment in browser.
python will respond with the output of the execution or time out after 60.0 seconds.
The drive at '/mnt/data' can be used to save and persist user files. But it won't be shared across sessions.
