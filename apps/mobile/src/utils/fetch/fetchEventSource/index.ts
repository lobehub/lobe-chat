...
export interface FetchEventSourceInit extends FetchRequestInit {
  /** The Fetch function to use. Defaults to expo/fetch */
...
export function fetchEventSource(
  ...
  return new Promise<void>((resolve) => {
    ...
    const fetch = inputFetch ?? expoFetch;
    async function create() {
      try {
        ...
        await inputOnOpen(response as unknown as Response);
