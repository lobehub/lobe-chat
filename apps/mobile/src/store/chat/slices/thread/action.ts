...
> = (set, get) => ({
  updateThreadInputMessage: (message) => {
    throw new Error('updateThreadInputMessage is not implemented yet');
  ...
  openThreadCreator: (messageId) => {
    throw new Error('openThreadCreator is not implemented yet');
    // set(
  ...
  openThreadInPortal: (threadId, sourceMessageId) => {
    throw new Error('openThreadInPortal is not implemented yet');
    // set(
  ...
  closeThreadPortal: () => {
    throw new Error('closeThreadPortal is not implemented yet');
    // set(
  ...
  sendThreadMessage: async ({ message }) => {
    throw new Error('sendThreadMessage is not implemented yet');
    /*   const {
  ...
  resendThreadMessage: async (messageId) => {
    throw new Error('resendThreadMessage is not implemented yet');
    // const chats = threadSelectors.portalAIChats(get());
    //
  ...
  delAndResendThreadMessage: async (id) => {
    throw new Error('delAndResendThreadMessage is not implemented yet');
    // get().resendThreadMessage(id);
    // get().deleteMessage(id);
  },
  createThread: async ({ message, sourceMessageId, topicId, type }) => {
    throw new Error('createThread is not implemented yet');
  ...
  useFetchThreads: (enable, topicId) => {
    throw new Error('useFetchThreads is not implemented yet');
    // return useSWR<ThreadItem[]>(
  ...
  removeThread: async (id) => {
    throw new Error('removeThread is not implemented yet');
  ...
  switchThread: async (id) => {
    throw new Error('switchThread is not implemented yet');
    // set({ activeThreadId: id }, false, n('toggleTopic'));
  },
  updateThreadTitle: async (id, title) => {
    throw new Error('updateThreadTitle is not implemented yet');
    // await get().internal_updateThread(id, { title });
  },

  summaryThreadTitle: async (threadId, messages) => {
    throw new Error('summaryThreadTitle is not implemented yet');
  ...
  internal_updateThread: async (id, data) => {
    throw new Error('internal_updateThread is not implemented yet');
