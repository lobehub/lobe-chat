...
export const createSessionSlice: StateCreator<SessionStore, [], [], SessionAction> = (
  set,
  get,
) => ({
  clearSessions: async () => {
  ...
  updateSearchKeywords: (keywords) => {
    set({ isSearching: !!keywords, sessionSearchKeywords: keywords }, false);
  },
  ...
  updateSessionMeta: async (meta) => {
    ...
    set({ signalSessionMeta: controller }, false);
