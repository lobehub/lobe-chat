...
export interface LogoMonoProps extends SvgProps {
  /**
   * 尺寸（宽度和高度相同）
   * @default 32
   */
...
const LogoMono = memo<LogoMonoProps>(({ size = 32, style, ...rest }) => {
  return (
    <Svg
      height={size}
    ...
    >
      ...
      <Path
        ...
        fill="#4F4F4F"
      />
      <Ellipse cx="12.017" cy="11.509" fill="#838383" rx="9.133" ry=".942" />
      <Path
      ...
      <Path
        ...
        fill="#838383"
      />
      <Circle cx="4.891" cy="1.025" fill="#838383" r=".778" />
      <Circle cx="20.699" cy="3.4" fill="#C8C8C8" r="1.27" />
      <Path
