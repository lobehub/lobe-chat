...
- ✅ 分类浏览 - 支持 7 个 emoji 分类（Emotion、People、Nature、Food、Places、Objects & Activities、Symbols）
...
The component includes 7 emoji categories:

1. **Smileys & Emotion** - 😀 笑脸和情感
2. **People & Body** - 🧑 人物和身体
3. **Animals & Nature** - 🦄 动物和自然
4. **Food & Drink** - 🍔 食物和饮料
5. **Travel & Places** - ✈️ 旅行和地点
6. **Objects & Activities** - 💡 物品和活动
7. **Symbols** - 🔣 符号
...
| `category`      | `EmojiCategory`                   | `Categories.emotion` | 初始选中的分类                                            |
