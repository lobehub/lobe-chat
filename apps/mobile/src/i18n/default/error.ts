export default {
  ...
  login: {
    accessDenied: '很抱歉，登录请求被拒绝，请稍后再试',
    cancelled: '您已取消登录',
    invalidGrant: '很抱歉，登录会话已失效，请稍后再试',
    invalidIdToken: '很抱歉，暂时无法获取您的账号信息，请稍后再试',
    invalidRequest: '很抱歉，登录请求有点问题，请稍后再试',
    invalidState: '很抱歉，登录校验未通过，请稍后再试',
    missingCodeOrState: '很抱歉，登录所需信息缺失，请稍后再试',
    missingPkce: '很抱歉，登录校验信息缺失，请稍后再试',
    networkError: '很抱歉，登录过程中网络异常，请检查网络后重试',
    noIdToken: '很抱歉，未能获取登录信息，请稍后再试',
    serverError: '很抱歉，登录服务出现异常，请稍后再试',
    temporarilyUnavailable: '很抱歉，登录服务暂时不可用，请稍后再试',
    tokenEndpointNonJson: '很抱歉，登录服务返回了异常响应，请稍后再试',
    tokenExchangeFailed: '很抱歉，登录处理出现异常，请稍后再试',
    unknown: '很抱歉，登录失败，请稍后再试',
    unsupportedResponseType: '很抱歉，当前登录方式暂不支持，请稍后再试',
  },
  page: {
  ...
  response: {
    ...
    '499':
      '很抱歉，您的请求在服务器处理中被意外中断，可能是因为您主动取消了操作或网络连接不稳定。请检查网络状况后重试。',
    ...
    '520':
      '很抱歉，服务器遇到了一个意外的问题，导致无法完成您的请求。请稍后再试，我们正努力解决这个问题。',
    '522':
      '很抱歉，服务器连接超时，未能及时响应您的请求。可能是网络不稳定或服务器暂时无法访问。请稍后再试，我们正在努力恢复服务。',
    ...
    'InvalidProviderAPIKey':
      '{{provider}} API Key 不正确或为空，请检查 {{provider}} API Key 后重试',
