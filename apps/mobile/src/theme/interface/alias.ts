...
export interface AliasToken extends MapToken {
  ...
  boxShadow: BoxShadow;
  /** @internal */
  boxShadowCard: BoxShadow;
  /** @internal */
  boxShadowDrawerDown: BoxShadow;
  /** @internal */
  boxShadowDrawerLeft: BoxShadow;
  /** @internal */
  boxShadowDrawerRight: BoxShadow;
  /** @internal */
  boxShadowDrawerUp: BoxShadow;

  // FIXME: component box-shadow, should be removed
  /** @internal */
  boxShadowPopoverArrow: BoxShadow;
  ...
  /** @internal */
  boxShadowTabsOverflowBottom: BoxShadow;

  /** @internal */
  boxShadowTabsOverflowLeft: BoxShadow;
  /** @internal */
  boxShadowTabsOverflowRight: BoxShadow;
  /** @internal */
  boxShadowTabsOverflowTop: BoxShadow;
  /**
   * @nameZH 三级阴影
  ...
  /**
   * @nameZH 容器二级背景色
   * @nameEN Secondary container background color
   * @desc 控制容器在二级状态下的背景色。
   * @descEN Control the background color of container in secondary state.
   */
