...
export const OUTPUT_PATH = path.resolve(ROOT_DIR, 'src/app/playground/_data/index.json');
export const DEMOS_MAP_PATH = path.resolve(ROOT_DIR, 'src/app/playground/_data/import.ts');
