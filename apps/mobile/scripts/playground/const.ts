...
export const OUTPUT_PATH = path.resolve(ROOT_DIR, 'src/app/playground/.data/index.json');
export const DEMOS_MAP_PATH = path.resolve(ROOT_DIR, 'src/app/playground/.data/import.ts');
