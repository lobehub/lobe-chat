import { DEFAULT_LANG, isLocaleNotSupport } from '@/mobile/const/locale';
import { normalizeLocale } from '@/mobile/i18n/resource';
import urlJoin from 'url-join';
import { DEFAULT_AGENT_INDEX } from '@/mobile/const/meta';
import { Locales } from '@/mobile/types/locale';
import { DiscoverAssistantItem } from '@/mobile/types/discover';
import { cloneDeep, merge } from 'lodash-es';
import { DEFAULT_DISCOVER_ASSISTANT_ITEM } from '@/mobile/const/discover';
import { apiLogger } from '@/mobile/utils/logger';
