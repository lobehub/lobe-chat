...
单元测试用于测试应用中的独立单元（如组件、函数、工具函数等）的功能。我们使用 [vitest](https://github.com/vitejs/vitest) 进行单元测试。
...
单元测试是针对应用中的最小可测试单元进行的测试，通常是针对函数、组件或模块进行的测试。在 LobeChat 中，我们使用 [vitest](https://github.com/vitejs/vitest) 进行单元测试。
