---
title: 渐进式 Web 应用（PWA）- 提升用户体验的现代 Web 技术
description: >-
  LobeChat 采用渐进式 Web 应用（PWA）技术，提供桌面和移动设备上的高度优化用户体验，保持轻量级和高性能特点。了解如何将 LobeChat
  添加为您的桌面应用。
tags: '渐进式 Web 应用, PWA, LobeChat, 用户体验, 桌面应用, 移动设备'
---
