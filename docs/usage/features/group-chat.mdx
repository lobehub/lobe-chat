...
Click the "Create Agent Team" button, you can choose to create directly from preset group chat templates, or select your own assistants to form a group chat.
