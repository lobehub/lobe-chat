...
<Image alt={'Using Qiniu\'s AI Models in LobeChat'} cover src={'TODO'} />
...
<Steps>
  ...
  - Method 1: Using Console
    ...
    <Image alt={'Obtain your API Key'} inStep src={'https://github.com/user-attachments/assets/a014769f-262c-4ee4-a727-2c3c45111574'} />
  ...
  <Image alt={'Enter API key'} inStep src={'https://github.com/user-attachments/assets/40bd5ec0-c2fe-4397-9ae1-f6d0b9e55287'} />

  - Open Qiniu and enter the obtained API key.
  - Choose a Qiniu's model for your AI assistant to start the conversation.

  <Image alt={'Select a Qiniu\'s model and start conversation'} inStep src={'https://github.com/user-attachments/assets/eadae11f-86e8-4a8d-944d-2f984e257356'} />
