...
<Steps>
  ...
  <Image alt={'获取 GroqCloud API Key'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/6942287e-fbb1-4a10-a1ce-caaa6663da1e'} width={832} />

  在控制台的 `API Keys` 菜单中创建一个 API Key。

  <Image alt={'保存 GroqCloud API Key'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/eb57ca57-4f45-4409-91ce-9fa9c7c626d6'} width={832} />
  ...
  <Image alt={'Groq 服务商设置'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/88948a3a-6681-4a8d-9734-a464e09e4957'} width={832} />

</Steps>

接下来，在助手的模型选项中，选中一个 Groq 支持的模型，就可以在 LobeChat 中体验 Groq 强大的性能了。

<Image alt={'选择 Groq 模型'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/c37190ee-b373-4c6f-8261-aa48e8d317e7'} width={832} />
