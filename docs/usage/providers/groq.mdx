...
<Steps>
  ...
  <Image alt={'Get GroqCloud API Key'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/6942287e-fbb1-4a10-a1ce-caaa6663da1e'} width={832} />

  Create an API Key in the `API Keys` menu of the console.

  <Image alt={'Save GroqCloud API Key'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/eb57ca57-4f45-4409-91ce-9fa9c7c626d6'} width={832} />
  ...
  <Image alt={'Groq service provider settings'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/88948a3a-6681-4a8d-9734-a464e09e4957'} width={832} />
...
<Image alt={'Select Groq model'} height={274} src={'https://github.com/lobehub/lobe-chat/assets/34400653/c37190ee-b373-4c6f-8261-aa48e8d317e7'} width={832} />
