...
<Steps>
  ...
  ![Lark Open Platform agent app banner with the Create button](https://app.lobehub.com/f/file_K4lzvmTvEGzC)
  ...
  ![Lark agent app creation form with an avatar and the name Lobehub Weekly Helper](https://app.lobehub.com/f/file_jLeQSs2pttJE)
  ...
  ![Lark App created page showing App ID with App Secret hidden](https://app.lobehub.com/f/file_eqe0bqUESiln)
