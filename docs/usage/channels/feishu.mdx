...
> **Note:** Both modes require the message event to be added on the Feishu Open Platform. Only **Webhook mode** needs an **Event Subscription URL**; **WebSocket mode** uses the long-connection subscription method.
