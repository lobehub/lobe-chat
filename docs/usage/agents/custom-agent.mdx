---
title: 'Adding and Iterating Assistants: A Comprehensive Guide'
description: >-
  Learn how to add assistants to your favorites list in LobeChat, either through
  the role market or by creating custom assistants for specific tasks. Get
  detailed instructions and tips for a seamless setup.
tags: >-
  LobeChat, assistant market, custom assistant, adding assistants, iterating
  assistants, assistant setup
---
