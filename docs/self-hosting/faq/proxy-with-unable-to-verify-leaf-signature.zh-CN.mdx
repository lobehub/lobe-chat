---
title: 解决使用代理时遇到 UNABLE_TO_VERIFY_LEAF_SIGNATURE 错误
description: 在私有化部署时，使用代理进行网络请求可能会遇到证书验证错误。了解如何通过设置环境变量或采取更安全的替代方案来解决这个问题。
tags: '代理服务器, 证书验证, UNABLE_TO_VERIFY_LEAF_SIGNATURE, 环境变量, Docker, 安全性'
---
