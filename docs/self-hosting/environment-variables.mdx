...
## Building a Custom Image with Overridden NEXT\_PUBLIC Variables

If you need to override NEXT\_PUBLIC environment variables, you can build a custom Docker image using GitHub Actions without forking the entire LobeChat repository. Here's a guide on how to do this:
...
4. In your GitHub Repository settings > Secrets and variables > Actions > Repository secrets, add any NEXT\_PUBLIC variables you want to override
...
This approach allows you to create a custom build with your desired NEXT\_PUBLIC variables without maintaining a full fork of the LobeChat repository. You can trigger a new build whenever you need to update your custom image.
