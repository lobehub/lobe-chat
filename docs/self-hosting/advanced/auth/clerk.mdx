...
>Note: The Clerk authentication service is enabled by default in Varcel deployments, but disabled by default in official Docker images. To enable it, you need to manually compile the image. For specific details, please refer to this [Issue](https://github.com/lobehub/lobe-chat/issues/3080).
