---
title: Integrating Vercel Analytics for LobeChat User Usage Analysis
description: >-
  Learn how to enable and utilize Vercel Analytics to collect website visit data
  for LobeChat, including traffic, sources, and devices used for access.
tags: 'Vercel Analytics, LobeChat, User Usage Analysis'
---
