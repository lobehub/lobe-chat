...
# 存储桶对外的访问域名
NEXT_PUBLIC_S3_DOMAIN=https://your-domain.com
```
...
<Callout type={'warning'}>`S3_ENDPOINT`必须删除其路径，否则会无法访问所上传文件</Callout>
    ...
    <Image
      alt={'配置 API token 权限'}
      src={'https://private-user-images.githubusercontent.com/19712631/346187470-01e042c0-cbcc-437b-8dd3-d417c8cc2621.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..DnBVp-ocrMyFRCFPf-Jlu_C81uVR2FeYRbzW1l7ofyo'}
    ></Image>
