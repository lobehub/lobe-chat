---
title: Configuration of Microsoft Entra ID Authentication Service
description: >-
  Learn how to configure Microsoft Entra ID Authentication Service, create
  applications, add users, and set up environment variables for seamless
  integration.
tags:
  - Microsoft Entra ID
