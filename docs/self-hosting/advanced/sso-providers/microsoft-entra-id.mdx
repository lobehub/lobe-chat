---
title: Configuring Microsoft Entra ID Authentication Service
description: >-
  Learn how to create a Microsoft Entra ID application, add users, and configure
  environment variables for deploying LobeChat with single sign-on (SSO) using
  Microsoft Entra ID.
tags: >-
  Microsoft Entra ID, Authentication Service, Single Sign-On, Azure AD,
  Environment Variables, LobeChat
---
