...
For Search1API-specific setup—including a recommended search + crawl configuration, API Key precedence, verification, and troubleshooting—see the [dedicated Search1API guide for LobeHub](https://s1.dev/integrations/lobehub).
