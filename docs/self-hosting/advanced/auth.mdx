...
| ------------------------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NEXT_PUBLIC_ENABLE_NEXT_AUTH` | Required | Used to enable the NextAuth service, set `1` to enable. Changing this requires recompilation. If you are deploying with Docker, please use the image lobehub/lobe-chat-database which has NextAuth enabled.     |
