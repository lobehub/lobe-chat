---
title: LobeChat 数据分析集成服务 - 免费 / 开源数据统计服务
description: 在 LobeChat 中集成了若干免费 / 开源的数据统计服务，用于收集用户的使用情况，包括 Vercel Analytics 和其他服务。
tags: 'LobeChat, 数据分析, 免费数据统计, 开源数据统计, Vercel Analytics'
---
# 数据分析
