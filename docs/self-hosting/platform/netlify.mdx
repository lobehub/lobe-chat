...
description: >-
  Learn how to deploy LobeChat on Netlify with detailed step-by-step
  instructions, including forking the repository, preparing the OpenAI API Key,
  importing to Netlify workspace, configuring site name and environment
  variables, waiting for deployment, and setting up a custom domain.
tags: >-
  Deploy LobeChat, Netlify Deployment, LobeChat Tutorial, OpenAI API Key, Custom
  Domain Setup
---
