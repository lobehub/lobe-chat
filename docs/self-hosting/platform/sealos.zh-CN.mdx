---
title: 在 SealOS 上部署 LobeChat - 使用 OpenAI API Key 进行快速部署
description: 按照指南准备 OpenAI API Key，点击按钮进行部署，完成后即可开始使用。选择绑定自定义域名或使用 SealOS 提供的子域名。
tags: 'SealOS, LobeChat, OpenAI API Key, 部署流程, 自定义域名'
---
# 使用 SealOS 部署
