---
title: Docker Compose Deployment Guide - Deploy LobeChat with Docker
description: >-
  Learn how to deploy the LobeChat service using Docker Compose, including
  installation, deployment commands, and optional automatic update script.
tags: >-
  Docker Compose, LobeChat, Docker Deployment, Automatic Update Script, Docker
