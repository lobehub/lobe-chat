---
title: Deploy LobeChat on Zeabur - Step-by-Step Guide
description: >-
  Learn how to deploy LobeChat on Zeabur with ease. Get your OpenAI API Key,
  click the deploy button, and start using LobeChat. Optional: Bind a custom
  domain for direct connections in most regions.
tags: 'Deploy LobeChat, Zeabur Deployment, OpenAI API Key, Custom Domain Binding'
---
