---
title: 在Zeabur上部署LobeChat - 使用OpenAI API Key进行快速部署
description: 按照以下步骤在Zeabur上部署LobeChat，准备OpenAI API Key并点击按钮进行部署，快速开始使用。可选绑定自定义域名。
tags: 'Zeabur, LobeChat, OpenAI API Key, 自定义域名, 快速部署'
---
