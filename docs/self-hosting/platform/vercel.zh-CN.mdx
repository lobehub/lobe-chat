---
title: Vercel 部署指引 - 部署 LobeChat
description: 按照指引在 Vercel 上部署 LobeChat，准备 OpenAI API Key，一键部署，绑定自定义域名，自动同步更新。
tags: 'Vercel 部署, LobeChat, OpenAI API Key, 自定义域名, 自动同步更新'
---
# Vercel 部署指引
