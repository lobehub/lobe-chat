---
title: 在RepoCloud上部署LobeChat - 一键部署指南
description: 学习如何在RepoCloud上部署LobeChat，准备OpenAI API Key，点击按钮进行部署，绑定自定义域名，开始使用LobeChat。
tags: 'RepoCloud部署, LobeChat, OpenAI API Key, 自定义域名'
---
