---
title: Deploy LobeChat on RepoCloud - One-Click Deployment
description: >-
  Learn how to deploy LobeChat on RepoCloud with a one-click deployment process.
  Start using LobeChat once deployed and optionally bind a custom domain.
tags: >-
  Deploy LobeChat, RepoCloud Deployment, One-Click Deployment, Custom Domain
  Binding
---
