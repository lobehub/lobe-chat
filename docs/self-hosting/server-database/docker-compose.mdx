...
```sh
curl -fsSL https://raw.githubusercontent.com/lobehub/lobe-chat/HEAD/docker-compose/local/setup.sh | bash
```
...
- [Port Mode](#port-mode): Supports LAN/public `http` access; suitable for personal use.
- [Domain Mode](#domain-mode): Supports LAN/public `http/https` access with reverse proxy; suitable for team use.
...
Casdoor:
  ...
  - Username: admin
  - Password: c66f8c
  - Client Secret: 21dfb303f2f3eb9a6d3c7cdb0d221d1c
Minio:
...
- `s3-ui.example.com`: optional, `9001`
