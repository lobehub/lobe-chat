...
<Steps>
  ...
  Make sure to add this to the Vercel environment variables as well, and the length of the secret was correct, you can refer to this [issues](https://github.com/lobehub/lobe-chat/issues/5547)
...
<Steps>
  ...
  <Callout type={'warning'}>
    The `https://` in the URL is essential to maintain the integrity of the URL. You will not know the URL of your Vercel project if it's your first time deploying it. Therefore, you can fill in a temporary domain for webhook creation and change it after deployment.
  </Callout>
