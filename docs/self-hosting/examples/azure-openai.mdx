---
title: >-
  Configuring Azure OpenAI for LobeChat: Usage Limitations and Configuration
  Steps
description: >-
  Learn how to configure Azure OpenAI for LobeChat, including usage limitations
  and step-by-step configuration in the interface and during deployment.
tags: >-
  Azure OpenAI, LobeChat, Configuration, Usage Limitations, API Key, Azure API
  Version
---
