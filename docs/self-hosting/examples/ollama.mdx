---
title: Integrating Ollama with LobeChat - Enhance Your Application
description: >-
  Learn how to configure and deploy LobeChat to use Ollama language models,
  including running Ollama and LobeChat locally.
tags: >-
  Ollama integration, LobeChat deployment, local language models, LLM
  integration
---
