---
title: Integrating Free/Open-Source Data Analytics Services in LobeChat
description: >-
  Explore the integration of Vercel Analytics, Google Analytics, PostHog
  Analytics, and Umami Analytics in LobeChat for collecting user usage data.
tags: >-
  Data Analytics, Vercel Analytics, Google Analytics, PostHog Analytics, Umami
  Analytics
---
