...
| 数字值 | `params.max_tokens=300`, `enableHistoryCount=5` | 设置最大令牌数为 `300`，设置历史消息条数为5。 |
| 布尔值 | `enableAutoCreateTopic=true`,`enableCompressThreshold=true`, `enableHistoryCount=true` | 启用自动创建主题，历史长度压缩阈值，历史记录条数。 |
