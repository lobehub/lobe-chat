...
- Type: Optional
- Description: Used to configure the default Embedding model for the LobeChat knowledge base.support model provider list: zhipu/github/openai/bedrock/ollama
- Default: `'embedding_model=openai/embedding-text-3-small'`
