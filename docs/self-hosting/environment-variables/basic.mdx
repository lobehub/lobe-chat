...
description: >-
  Learn about the environment variables available for customizing LobeChat
  deployment, including access code, OAuth SSO, base path, default agent
  configuration, identity verification service settings, plugin service
  settings, and assistant market settings.
tags: >-
  LobeChat, Environment Variables, Deployment, Access Code, OAuth SSO, Base
  Path, Default Agent Configuration, Identity Verification Service, Plugin
  Service, Assistant Market
---
