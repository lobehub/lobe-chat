---
title: Model Service Providers and Environment Variables for LobeChat
description: >-
  Explore the environment variables related to various model service providers
  for LobeChat, including OpenAI, Azure OpenAI, ZHIPU AI, Moonshot AI, Google
  AI, AWS Bedrock, Ollama, Perplexity AI, Anthropic AI, Mistral AI, Groq AI, and
  OpenRouter AI.
tags: >-
  Model Service Providers, Environment Variables, LobeChat, OpenAI, Azure
  OpenAI, ZHIPU AI, Moonshot AI, Google AI, AWS Bedrock, Ollama, Perplexity AI,
  Anthropic AI, Mistral AI, Groq AI, OpenRouter AI
---
