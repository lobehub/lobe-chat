...
- Type: Required
- Description: The API key created in the Token Market console.
- Default: `-`
- Example: `sk-xxxxxx...xxxxxx`

### `TOKENSMARKET_MODEL_LIST`

- Type: Optional
- Description: Used to specify a custom Token Market model list. Model definition syntax rules see [model-list][model-list]
- Default: `-`
- Example: `-all,+gpt-5.4-mini,+claude-sonnet-5`
