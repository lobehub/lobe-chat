...
- Example: `https://api.chatanywhere.tech` or `https://aihubmix.com/v1`

<Callout type={'warning'}>
  The `https://api.chatanywhere.com.cn/` endpoint will be discontinued. Please switch to `https://api.chatanywhere.tech/`.
</Callout>
