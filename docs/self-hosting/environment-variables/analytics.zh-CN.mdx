---
title: LobeChat 数据统计服务环境变量
description: >-
  了解 LobeChat 中集成的免费 / 开源数据统计服务的环境变量，包括 Vercel Analytics, Google Analytics,
  Posthog Analytics, 和 Umami Analytics。
tags: >-
  LobeChat, 数据统计, 环境变量, Vercel Analytics, Google Analytics, Posthog Analytics,
  Umami Analytics
---
# 数据统计
