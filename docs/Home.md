...
- [Upstream SyncA. Vercel / Zeabur DeploymentB. Docker Deployment](https://github.com/lobehub/lobe-chat/wiki/Upstream-Sync) | [自部署保持更新 Vercel / Zeabur 部署 Docker 部署](https://github.com/lobehub/lobe-chat/wiki/Upstream-Sync.zh-CN)
...
- [LobeChat New Locale Guide](https://github.com/lobehub/lobe-chat/wiki/Add-New-Locale) | [LobeChat 新语种添加指南](https://github.com/lobehub/lobe-chat/wiki/Add-New-Locale.zh-CN)
