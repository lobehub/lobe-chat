...
如果要添加新语种，需遵循特定步骤，详见 [新语种添加指南](./internationalization/add-new-locale.zh-CN)。 我们鼓励你参与我们的国际化努力，共同为全球用户提供更好的服务。

详细的国际化实现指南，请参考 [国际化实现指南](./internationalization/internationalization-implementation.zh-CN)。

## 附录：资源与参考

为了支持开发者更好地理解和使用 LobeChat 的技术栈，我们提供了一份详尽的资源与参考列表 —— [LobeChat 资源与参考](./basic/resources.zh-CN) - 访问我们维护的资源列表，包括教程、文章和其他有用的链接。
