...
For a detailed introduction to the directory structure, see: [Folder Directory Structure](folder-structure.zh-CN.mdx)
...
Now, you should be able to see the welcome page of LobeChat in your browser. For a detailed environment setup guide, please refer to [Development Environment Setup Guide](setup-development.zh-CN.mdx).
...
For detailed code style and contribution guidelines, please refer to [Code Style and Contribution Guide](contributing-guidelines.zh-CN.mdx).
...
If you want to add a new language, follow specific steps detailed in [New Language Addition Guide](../internationalization/add-new-locale.mdx). We encourage you to participate in our internationalization efforts to provide better services to global users.

For a detailed guide on internationalization implementation, please refer to [Internationalization Implementation Guide](../internationalization/internationalization-implementation.mdx).

## Appendix: Resources and References

To support developers in better understanding and using the technology stack of LobeChat, we provide a comprehensive list of resources and references — [LobeChat Resources and References](./basic/resources.mdx) - Visit our maintained list of resources, including tutorials, articles, and other useful links.
