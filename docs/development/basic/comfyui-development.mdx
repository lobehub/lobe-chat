...
```typescript
// packages/model-runtime/src/comfyui/index.ts
...
```typescript
// packages/model-runtime/src/comfyui/config/modelRegistry.ts
...
```typescript
// packages/model-runtime/src/comfyui/config/fluxModelRegistry.ts
...
```typescript
// packages/model-runtime/src/comfyui/config/sdModelRegistry.ts
...
```typescript
// packages/model-runtime/src/comfyui/config/workflowRegistry.ts
...
```typescript
// packages/model-runtime/src/comfyui/workflows/flux-dev.ts (simplified)
...
```typescript
// packages/model-runtime/src/comfyui/config/systemComponents.ts
...
```typescript
// packages/model-runtime/src/comfyui/services/modelResolver.ts
...
```typescript
// packages/model-runtime/src/comfyui/errors/
...
```
packages/model-runtime/src/comfyui/__tests__/
├── setup/
...
```typescript
// packages/model-runtime/src/comfyui/workflows/myNewModel.ts
...
```typescript
// packages/model-runtime/src/comfyui/__tests__/fixtures/parameters.fixture.ts
import {
