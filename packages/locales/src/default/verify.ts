export default {
  ...
  'flow.groupProgress': '{{passed}} / {{total}} verified',
  'flow.groupReviewed': '{{count}} accepted',
  'flow.allGroups': 'All flows',
  'flow.fullscreen': 'Full screen',
  ...
  'flow.checks.hint':
    'Each node is a checklist item. The latest flow version shares its results, evidence and reviews with the graph; retries stay in result history.',
  ...
  'flow.actual': 'Observed result',
  'flow.noAttachments': 'No additional evidence attached. See the observation above.',
  'flow.editReview': 'Edit review',
  'flow.reviewResult': 'Review this result',

  'flow.state.partial': 'Some paths verified',
  'flow.completed': 'Verification complete',
  ...
  'flow.run': 'Run {{number}}',
  'flow.coverage': 'Required branches: {{count}} / {{total}}',
  'flow.instruction': 'How to reach this state',
  'flow.expected': 'Expected behavior',
  'flow.attempts': 'Verification history',
  'flow.unvisited': 'This state has not been verified on this path.',
  'flow.evidence': 'View evidence',
  'flow.comment': 'Review comment',
  'flow.saveError': 'Could not save your review. Please retry.',
  'flow.state.pending': 'Not verified',
  'flow.state.passed': 'Passed',
  'flow.state.failed': 'Failed',
  'flow.state.uncertain': 'Uncertain',
  'flow.state.blocked': 'Blocked',
  'flow.review.accepted': 'Confirmed',
  'flow.review.rejected': 'Needs work',
  ...
  'acceptance.checks.holisticTitle': 'Acceptance',
  ...
  'acceptance.comments.linkCopied': 'Link copied',
  'acceptance.comments.delete': 'Delete',
  'acceptance.comments.deleteConfirm': 'Delete this comment?',
  'acceptance.comments.deleted': 'This comment was deleted',
  ...
  'acceptance.comments.approveSummaryPlaceholder': 'One-line summary (optional)',
  'acceptance.comments.withdraw': 'Withdraw approval',
  'acceptance.comments.withdrawDescription':
    'You can withdraw or give this again at any time while the round is open — only where you land when the owner decides counts.',
  'acceptance.comments.approveAgain': 'Approve this round',
  'acceptance.comments.approved': 'Approved',
  ...
  'acceptance.shell.menu': 'Show Acceptance menu',
  ...
  'acceptance.workspace.emptyDetail.description':
    'Open the Acceptance menu to pick a record and inspect its checks, rounds and evidence.',
  ...
  'flow.startVerification': 'Start verification',
  'flow.rerunVersion': 'Rerun this version',
  'flow.roundCreated': 'New round created. Checks await execution.',
};
