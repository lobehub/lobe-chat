...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'trash.actions.failed': 'Could not complete that action. Please try again.',
  'trash.actions.loadMore': 'Load more',
  'trash.actions.purge': 'Delete forever',
  'trash.actions.purgeSelected': 'Delete {{count}} forever',
  'trash.actions.restore': 'Restore',
  'trash.actions.restoreSelected': 'Restore {{count}}',
  'trash.columns.deletedAt': 'Deleted',
  'trash.columns.deletedBy': 'Deleted by',
  'trash.columns.expiresIn': 'Auto-deletes',
  'trash.columns.name': 'Name',
  'trash.columns.type': 'Type',
  'trash.desc':
    'Deleted Resource items stay here for {{days}} days and can be restored. After that they are removed permanently.',
  'trash.deletedBy.unknown': 'Former member',
  'trash.deletedBy.you': 'You',
  'trash.empty.desc':
  ...
  'trash.error.desc': 'Your deleted items are safe. Reload to try fetching them again.',
  'trash.error.title': 'Could not load Trash',
  'trash.expiresIn.days': 'in {{count}} days',
  'trash.expiresIn.soon': 'within a day',
  'trash.filter.all': 'All',
  'trash.loadMore.failed': 'Could not load more deleted items. Try again.',
  'trash.purge.partial': 'Deleted {{purged}} item(s); {{failed}} could not be deleted.',
  'trash.purgeConfirm.content': 'Permanently delete "{{title}}"? This cannot be undone.',
  'trash.purgeConfirm.multiContent':
  ...
  'trash.restore.successCount': 'Restored {{count}} item(s)',
  'trash.purge.success': 'Deleted permanently',
  'trash.purge.successCount': 'Permanently deleted {{count}} item(s)',
  'trash.selection.count': '{{count}} selected',
  'trash.title': 'Trash',
  'trash.type.document': 'Document or folder',
  'trash.type.file': 'File',
  'trash.type.knowledgeBase': 'Knowledge base',
