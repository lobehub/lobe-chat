export default {
  ...
  'apikey.form.fields.scopes.fullAccessDescription':
    'This key can do everything your account can do',
  ...
  'apikey.list.actions.creationRestricted':
    'Your workspace administrator has restricted API Key creation to admins',
  ...
  'oauthApp.form.redirectUris.extra':
    'One per line. Must be an exact https URL (http is allowed on localhost only).',
  ...
  'oauthApp.form.type.deviceDesc':
    'For CLIs and devices without a browser. Users authorize with a code shown in the terminal.',
  'oauthApp.form.type.label': 'Application Type',
  'oauthApp.form.type.webDesc':
    'For server-side apps. Users are redirected back to your app, which authenticates with a client secret.',
  ...
  'oauthApp.secret.onceWarning':
    'This is the only time the client secret is shown. Store it somewhere safe before closing.',
  'oauthApp.secret.revealTitle': 'Your client secret',
  'oauthApp.secret.rotate': 'Rotate',
  'oauthApp.secret.rotateConfirm.content':
    'The current secret stops working immediately. Any deployment still using it will fail to sign users in until you update it.',
  ...
  'oauthApp.validation.redirectUri.credentials':
    'A redirect URI cannot embed a username or password',
  ...
  'oauthApp.validation.redirectUri.wildcard':
    'Wildcards are not allowed; redirect URIs are matched exactly',
