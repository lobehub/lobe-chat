export default {
  ...
  'goalExperiment.location': 'Exploration location',
  'goalExperiment.expandScope': 'Expand this view',
  'goalExperiment.collapseScope': 'Collapse this view',
  'goalExperiment.emptyGraph': 'This experiment has no internal nodes yet.',

  'goalExperiment.overviewCount': 'Total: {{count}} experiments · {{nodes}} nodes',
  'goalExperiment.expandAll': 'Expand all',
  'goalExperiment.collapseAll': 'Collapse all',
  'goalExperiment.collapseNamed': 'Collapse experiment: {{title}}',
  'goalExperiment.projectedRelation': '{{relation}} (internal link)',
  'goalExperiment.baseline': 'Starting experiment · no parent experiment',
  'goalExperiment.noResult': 'No result has been recorded for this experiment yet.',
  'goalExperiment.number': 'Experiment #{{number}}',
  'goalExperiment.execution': 'Execution history',
  'goalExperiment.delivery': 'View delivery',
  'goalExperiment.answers': 'Candidate answer',
  'goalExperiment.root': 'All exploration',
  'goalExperiment.inspect': 'Experiment details',
  'goalExperiment.members': '{{count}} nodes',
  'goalExperiment.enter': 'Expand in this graph',
  'goalExperiment.status.proposed': 'Not started',
  'goalExperiment.status.active': 'Exploring',
  'goalExperiment.status.waiting': 'Waiting for a decision',
  'goalExperiment.status.resolved': 'Work completed',
  'goalExperiment.status.rejected': 'Rejected',
  'goalExperiment.status.retired': 'Retired',
  'goalExperiment.acceptance': 'View verification',
  'goalExperiment.result': 'Experiment results',
  'goalExperiment.lineage': 'Experiment lineage',
  'goalExperiment.parentLink': 'From #{{number}} · {{title}}',
  'goalExperiment.childLink': 'Continued as #{{number}} · {{title}}',
  'goalExperiment.instruction': 'What this experiment tests',
  'goalExperiment.inputs': 'Pinned input versions ({{count}})',
  'goalExperiment.inputHint':
  ...
  'goalProcess.edge.derivedFrom': 'Derived from',
  ...
  'goalProcess.kind.experiment': 'Experiment',
  ...
  'workingPanel.pr.action.arming': 'Arming auto-merge…',
  'workingPanel.pr.action.autoMerge': 'Auto-merge when ready',
  'workingPanel.pr.action.bypassSuffix': 'bypass rules',
  'workingPanel.pr.action.calculating': 'Calculating…',
  'workingPanel.pr.action.conflicting': 'Resolve conflicts to merge',
  'workingPanel.pr.action.deleteBranch': 'Delete branch',
  'workingPanel.pr.action.deleting': 'Deleting branch…',
  'workingPanel.pr.action.disableAutoMerge': 'Disable',
  'workingPanel.pr.action.merging': 'Merging…',
  'workingPanel.pr.action.push_one': 'Push {{count}} commit',
  'workingPanel.pr.action.push_other': 'Push {{count}} commits',
  'workingPanel.pr.action.pushing': 'Pushing…',
  'workingPanel.pr.action.ready': 'Mark ready for review',
  'workingPanel.pr.action.readying': 'Marking ready…',
  'workingPanel.pr.action.reopen': 'Reopen pull request',
  'workingPanel.pr.action.reopening': 'Reopening…',
  'workingPanel.pr.action.updateBranch': 'Update branch',
  'workingPanel.pr.action.updateBranch.merge': 'Update with merge commit',
  'workingPanel.pr.action.updateBranch.rebase': 'Update with rebase',
  'workingPanel.pr.action.updating': 'Updating branch…',
  'workingPanel.pr.action.waiting': 'Waiting for checks…',
  'workingPanel.pr.activity.approved': 'approved',
  'workingPanel.pr.activity.changesRequested': 'requested changes',
  'workingPanel.pr.activity.commented': 'reviewed',
  'workingPanel.pr.activity.committed': 'committed',
  'workingPanel.pr.activity.dismissed': 'review dismissed',
  'workingPanel.pr.bypass': 'Merge without waiting for requirements',
  'workingPanel.pr.check.optional': 'optional',
  'workingPanel.pr.check.queued': 'queued',
  'workingPanel.pr.checks.failing_one': '{{count}} failing',
  'workingPanel.pr.checks.failing_other': '{{count}} failing',
  'workingPanel.pr.checks.running_one': '{{count}} running',
  'workingPanel.pr.checks.running_other': '{{count}} running',
  'workingPanel.pr.composer.placeholder': 'Write a comment…',
  'workingPanel.pr.composer.submit': 'Comment',
  'workingPanel.pr.dismiss': 'Dismiss',
  'workingPanel.pr.error.load': 'Could not load this pull request',
  'workingPanel.pr.files.openReview': 'Open diff in Review',
  'workingPanel.pr.ghMissing.desc':
    'Install `gh` and run `gh auth login` to load pull requests here.',
  'workingPanel.pr.ghMissing.open': 'Open in Browser',
  'workingPanel.pr.ghMissing.retry': 'Check again',
  'workingPanel.pr.ghMissing.title': "GitHub CLI isn't set up on this device",
  'workingPanel.pr.header.commits_one': '{{count}} commit',
  'workingPanel.pr.header.commits_other': '{{count}} commits',
  'workingPanel.pr.hint.autoMerge':
    'Will {{method}} once checks pass. Cancels on new commits or a changes-requested review.',
  'workingPanel.pr.hint.blocked':
    'Push a fix or wait for requirements; this refreshes automatically.',
  'workingPanel.pr.hint.bypass': 'Bypass is recorded on GitHub and visible in the audit log.',
  'workingPanel.pr.hint.calculating':
    'GitHub is recomputing after the last push; usually a few seconds.',
  'workingPanel.pr.hint.localAhead_one':
    'The pull request does not include your latest {{count}} local commit.',
  'workingPanel.pr.hint.localAhead_other':
    'The pull request does not include your latest {{count}} local commits.',
  'workingPanel.pr.hint.merge_one': 'Merges {{count}} commit into {{base}}.',
  'workingPanel.pr.hint.merge_other': 'Merges {{count}} commits into {{base}}.',
  'workingPanel.pr.hint.merged': '{{head}} is safe to delete.',
  'workingPanel.pr.hint.readOnly': 'Only maintainers of {{repo}} can merge this pull request.',
  'workingPanel.pr.menu.close': 'Close pull request',
  'workingPanel.pr.menu.copied': 'Link copied',
  'workingPanel.pr.menu.copyLink': 'Copy link',
  'workingPanel.pr.menu.openOnGithub': 'Open on GitHub',
  'workingPanel.pr.menu.reopen': 'Reopen pull request',
  'workingPanel.pr.method.merge': 'Create a merge commit',
  'workingPanel.pr.method.merge.desc': 'Keep all commits and add a merge commit on {{base}}.',
  'workingPanel.pr.method.rebase': 'Rebase and merge',
  'workingPanel.pr.method.rebase.desc': 'Replay the commits onto {{base}}.',
  'workingPanel.pr.method.squash': 'Squash and merge',
  'workingPanel.pr.method.squash.desc': 'Combine the commits into one on {{base}}.',
  'workingPanel.pr.retry': 'Retry',
  'workingPanel.pr.row.autoMerge.armed': 'Auto-merge armed ({{method}})',
  'workingPanel.pr.row.base.behind': 'Behind base branch',
  'workingPanel.pr.row.base.calculating': 'Calculating mergeability…',
  'workingPanel.pr.row.base.clean': 'No conflicts with {{base}}',
  'workingPanel.pr.row.base.closed': 'Closed without merging',
  'workingPanel.pr.row.base.conflicting': 'Conflicts with the base branch',
  'workingPanel.pr.row.base.draft': 'Draft — cannot be merged yet',
  'workingPanel.pr.row.base.merged': 'Merged',
  'workingPanel.pr.row.checks.failure': 'Checks failed',
  'workingPanel.pr.row.checks.pending': 'Checks running',
  'workingPanel.pr.row.checks.success': 'All checks passed',
  'workingPanel.pr.row.checks.unstable': 'Optional check failed',
  'workingPanel.pr.row.error': 'Merge failed: {{message}}',
  'workingPanel.pr.row.local': '{{ahead}} commits not pushed · {{dirty}} uncommitted',
  'workingPanel.pr.row.review.approved': 'Approved',
  'workingPanel.pr.row.review.changesRequested': 'Changes requested',
  'workingPanel.pr.row.review.none': 'No review required',
  'workingPanel.pr.row.review.reviewRequired': 'Review required',
  'workingPanel.pr.row.review.trailingApproved_one': '{{count}} approval',
  'workingPanel.pr.row.review.trailingApproved_other': '{{count}} approvals',
  'workingPanel.pr.row.review.trailingAuthors': '{{authors}}',
  'workingPanel.pr.row.rules.blocked': 'Blocked by branch rules',
  'workingPanel.pr.row.rules.bypass': 'Bypassing branch protection',
  'workingPanel.pr.row.rules.ready': 'Ready to merge',
  'workingPanel.pr.rules.admin': 'admin',
  'workingPanel.pr.section.activity': 'Activity',
  'workingPanel.pr.section.checks': 'Checks',
  'workingPanel.pr.section.commits': 'Commits',
  'workingPanel.pr.section.description': 'Description',
  'workingPanel.pr.section.files': 'Files changed',
  'workingPanel.pr.state.closed': 'Closed',
  'workingPanel.pr.state.draft': 'Draft',
  'workingPanel.pr.state.merged': 'Merged',
  'workingPanel.pr.state.open': 'Open',
