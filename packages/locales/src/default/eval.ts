export default {
  ...
  'dataset.create.fork.filter.hint':
    'Leave empty to include all categories from the source dataset.',
  ...
  'dataset.create.fork.sampling.hint':
    'Sample up to {{count}} test case{{count, plural, one {} other {s}}} from the filtered source set.',
  ...
  'capture.criteriaPlaceholder':
    'What must a good answer do? e.g. it must not treat the user as the author of the quoted message.',
  ...
  'capture.expectedPlaceholder':
    'Leave empty when you do not know the right answer \u2014 it is scored by the criteria alone',
  'capture.input': 'Input',
  'capture.notCapturable':
  ...
  'experiment.actions.delete.confirm':
    'Are you sure you want to delete this experiment? Its runs and scoped datasets will no longer be grouped here.',
  ...
  'overview.sections.experiments.subtitle':
    'Optimization workspaces for scoped datasets, baselines, and forked iterations.',
  ...
  'run.create.forkSummary.snapshot':
    'A fresh snapshot will be generated from the current agent configuration.',
