export default {
  ...
  'skills.details.comments.anonymous': 'Anonymous',

  'skills.details.comments.loadMore': 'Load More',

  'skills.details.comments.noComments': 'No reviews yet',

  'skills.details.header.installed': 'Installed',

  'skills.details.header.stats.github': 'GitHub',

  'skills.details.header.stats.installs': 'Installs',

  'skills.details.header.stats.rating': 'Rating',
  ...
  'skills.details.info.installs': 'Installs',

  'skills.details.info.license': 'License',

  'skills.details.info.publisher': 'Publisher',

  'skills.details.info.source': 'Source',

  'skills.details.info.stars': 'Stars',

  'skills.details.info.updated': 'Updated',

  'skills.details.info.version': 'Version',

  'skills.details.info.viewOnGithub': 'View on GitHub',

  'skills.details.info.viewSource': 'View source',

  'skills.details.installation.filesIncluded': 'Files Included',

  'skills.details.nav.info': 'Info',

  'skills.details.nav.install': 'Install',

  'skills.details.nav.reviews': 'Reviews',

  'skills.details.overview.about': 'About',

  'skills.details.overview.features': 'Features',

  'skills.details.overview.instructions': 'SKILL.md',

  'skills.details.overview.title': 'Overview',

  'skills.details.overview.version': 'Version {{version}}',

  'skills.details.overview.whatsNew': "What's New",

  'skills.details.rating.noRatings': 'No ratings yet',

  'skills.details.rating.totalRatings': '{{count}} ratings',
