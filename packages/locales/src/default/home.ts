export default {
  ...
  'dashboard.mode.note': 'Note',
  'dashboard.mode.task': 'Task',
  'dashboard.modeDesc.note': 'Jot a quick note; tags and annotation fill in automatically',
  'dashboard.modeDesc.task': 'Create a task, start it now, and track its progress',
  'dashboard.note.unsupportedContext':
    'Notes do not support attachments or selected context yet. Remove them or switch modes; your draft has been kept.',
  'dashboard.placeholder.chat': 'Ask, create, or start a task',
  'dashboard.placeholder.note':
    'Whatever comes to mind, drop it here. The original stays; annotation and follow-up leads fill in later.',
