export default {
  ...
  'config.background.label': 'Background',
  'config.background.options.auto': 'Automatic',
  'config.background.options.opaque': 'Opaque',
  'config.background.options.transparent': 'Transparent',
