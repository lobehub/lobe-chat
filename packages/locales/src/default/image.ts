export default {
  ...
  'config.thinkingLevel.label': 'Thinking Level',
  'config.thinkingLevel.options.high': 'High',
  'config.thinkingLevel.options.low': 'Low',
  'config.thinkingLevel.options.medium': 'Medium',
  'config.thinkingLevel.options.minimal': 'Minimal',
