...
const qiniuChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    description: 'MiniMax-M2.1 是一款轻量级、前沿的大语言模型，针对编码、代理工作流程和现代应用开发进行了优化，提供了更干净、更简洁的输出和更快的感知响应时间。',
  ...
  },
  {
    ...
    description: 'GLM-4.7 是智谱最新旗舰模型，通用能力提升，回复更简洁自然，写作更具沉浸感。',
    displayName: 'GLM-4.7',
    enabled: true,
    id: 'z-ai/glm-4.7',
    maxOutput: 128_000,
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: '智谱旗舰模型 GLM-4.6，在高级编码、长文本处理、推理与智能体能力上全面超越前代。',
    displayName: 'GLM-4.6',
    enabled: true,
    id: 'z-ai/glm-4.6',
    maxOutput: 128_000,
