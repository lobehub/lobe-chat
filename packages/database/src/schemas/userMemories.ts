...
export const userMemories = pgTable(
  'user_memories',
  {
    ...
    /**
     * 'labels' stores code/business/user-assigned labels for the memory.
     *  Contains essential tags, metadata, or categories for organizing and retrieving memories.
     */
    labels: jsonb('labels'),

    /**
     * 'extractedLabels' stores labels automatically extracted from the memory content.
     * These are generated by the system (e.g., via LLM/NLP/ML) and may differ from user-assigned labels.
     */
