...
# Back-compat args for your existing Actions
ARG NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY_ARG
ARG CLERK_WEBHOOK_SECRET_ARG
ARG CLERK_SECRET_KEY_ARG
...
ENV NEXT_PUBLIC_SERVICE_MODE="${NEXT_PUBLIC_SERVICE_MODE:-server}" \
    ...
    NEXT_PUBLIC_ENABLE_CLERK_AUTH="${NEXT_PUBLIC_ENABLE_CLERK_AUTH:-1}" \
    NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY="${NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:-$NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY_ARG}" \
    CLERK_WEBHOOK_SECRET="${CLERK_WEBHOOK_SECRET_ARG}" \
    CLERK_SECRET_KEY="${CLERK_SECRET_KEY_ARG}" \
